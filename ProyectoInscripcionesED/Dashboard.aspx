...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2 class="text-center mb-4">Panel de KPIs</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <h5 class="card-title text-center">Total de Usuarios Registrados</h5>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <h5 class="card-title text-center">Total de Usuarios Activos</h5>
                    <p class="card-text text-center">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <h5 class="card-title text-center">Tasa de Conversión de Inscripciones</h5>
                    <p class="card-text text-center">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <h5 class="card-title text-center">Total de Inscripciones</h5>
                    <p class="card-text text-center">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <h5 class="card-title text-center">Tasa de Asistencia Promedio</h5>
                    <p class="card-text text-center">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <h5 class="card-title text-center">Tasa de Certificación</h5>
                    <p class="card-text text-center">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <h5 class="card-title text-center">Total de Talleres Realizados</h5>
                    <p class="card-text text-center">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <h5 class="card-title text-center">Total de Certificados Emitidos</h5>
                    <p class="card-text text-center">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <h5 class="card-title text-center">Tiempo Promedio de Asistencia por Taller</h5>
                    <p class="card-text text-center">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <h5 class="card-title text-center">Tasa de Cancelación de Talleres</h5>
                    <p class="card-text text-center">
