<%@ Page Title="Agregar Inscripción" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgregarInscripcion.aspx.cs" Inherits="ProyectoInscripcionesED.AgregarInscripcion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Agregar Inscripción</h2>

    <!-- Formulario para agregar la inscripción -->
    <form id="formAgregarInscripcion" runat="server">
        <!-- Seleccionar Usuario -->
        <div>
        ...
        <div>
            <asp:Button ID="btnGuardar" runat="server" Text="Guardar Inscripción" CssClass="btn btn-primary" OnClick="btnGuardar_Click" />
        </div>
